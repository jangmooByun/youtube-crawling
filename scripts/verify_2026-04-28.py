"""End-to-end verification for data/2026-04-28/ after discover_2026-04-28.

Checks:
  (1) per-category row counts + bio-crawl-derived breakdown + country mix
  (2) JP/KR exclusion (must be 0)
  (3) cross-date dedup against 2026-04-24 + 2026-04-25 + 2026-04-27 (must be 0)
