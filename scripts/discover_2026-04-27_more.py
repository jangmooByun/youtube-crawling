"""Aggressive `_more` re-sweep of `fitness` (yoga / pilates / bodyweight) into
`data/2026-04-27/`. Pairs with discover_2026-04-27.py — same 13 keywords, but
deeper pages and lower subscriber floor to surface mid-tier creators
(1K~10K, AppBillChat ICP sweet spot).

Differences from base discover_2026-04-27.py:
  - PAGES_PER_KEYWORD: 2 → 4
  - MIN_SUBS: 5000 → 1000
  - C_CRAWL_MIN_SUBS: 5000 → 1000
  - TARGET_PER_CATEGORY: 100 → 300

Existing 35 rows in fitness.csv are preserved automatically via URL/email
dedup against DATED_NEW. Stops cleanly on quotaExceeded.
"""
